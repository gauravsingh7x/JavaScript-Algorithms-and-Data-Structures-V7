...
A structured collection of my [freeCodeCamp.org](https://www.freecodecamp.org/certification/gauravsingh7x/javascript-algorithms-and-data-structures) certification solutions — learning to code, solving challenges, and documenting my journey from “why isn’t this working?” to “oh… now it works.”
</br>
If this repository helped you in any way, feel free to leave a ⭐ — it’s greatly appreciated!
</br>

## Courses
1. [**Basic JavaScript**](https://github.com/gauravsingh7x/JavaScript-Algorithms-and-Data-Structures-V7/blob/master/Basic%20JavaScript.js) **(113 Tasks)**

2. [**ES6 Challenges**](https://github.com/gauravsingh7x/JavaScript-Algorithms-and-Data-Structures-V7/blob/master/ES6.js) **(29 Tasks)**
...
3. [**Regular Expressions Challenges**](https://github.com/gauravsingh7x/JavaScript-Algorithms-and-Data-Structures-V7/blob/master/Regular%20Expressions.js) **(33 Tasks)**

Regular expressions are special strings that represent a search pattern. Also known as "regex" or "regexp", they help programmers match, search, and replace text. Regular expressions can appear cryptic because a few characters have special meaning. The goal is to combine the symbols and text into a pattern that matches what you want, but only what you want. This section will cover the characters, a few shortcuts, and the common uses for writing regular expressions.

4. [**Debugging**](https://github.com/gauravsingh7x/JavaScript-Algorithms-and-Data-Structures-V7/blob/master/Debugging.js) **(12 Tasks)**
...
5. [**Basic Data Structures**](https://github.com/gauravsingh7x/JavaScript-Algorithms-and-Data-Structures-V7/blob/master/Basic%20Data%20Structures.js) **(20 Tasks)**
...
6. [**Basic Algorithm Scripting**](https://github.com/gauravsingh7x/JavaScript-Algorithms-and-Data-Structures-V7/blob/master/Basic%20Algorithm%20Scripting.js) **(16 Tasks)**
...
8. [**Functional Programming**](https://github.com/gauravsingh7x/JavaScript-Algorithms-and-Data-Structures-V7/blob/master/Functional%20Programming.js) **(24 Tasks)**
